					...
					success: function (data) {
						...
						if (data == false) {
							searchResultProducts +=
								"<div class='py-5 mx-auto'>Ops, Result Not Found. Try other words </div>";
						} else {
							searchResultProducts +=
								'<h1 class="text-gray-600 font-bold py-2"> Products Results </h1>';
							searchResultProducts +=
								'<div class="grid gid-cols-3 mt-5">';
							searchResultProducts +=
								'<div class="grid gap-5 md:grid-cols-5 grid-flow-col auto-rows-max overflow-x-scroll">';
