<?php $whatext = "Hello, .. "; ?>
<section class="w-full bg-gray-800 mt-20 py-20 inset-x-0 bottom-0 footer-bg">
        ...
        <div class="flex md:flex-row flex-col md:space-x-10 md:space-y-0 space-y-10">
            ...
            <div class="flex flex-col">
                <ul class="md:text-sm text-xs">
                    ...
                    <li class="py-1">
                        <a class="hover:text-gray-500 hover:underline text-gray-400 font-semibold items-center " href="">
                            <?= objectSocmed('Instagram'); ?>
                        </a>
                    </li>
                    <li class="py-1">
                        <a target="_blank" href="https://wa.me/6281317352815/?text=<?php echo $whatext; ?>" class="hover:text-gray-500 hover:underline text-gray-400 font-semibold items-center " href="">
