                ...
                <div class="flex flex-col lg:flex-row lg:space-x-4 mt-2">
                    ...
                    <span class="text-gray-800 font-bold mt-2 lg:flex-1">
                        <label class="block text-sm" id="change_status_order">
                            ...
                            <select name="status_baru" class="block w-full text-sm  bg-gray-100 focus:bg-white dark:bg-gray-700 form-select focus:border-green-400 focus:outline-none focus:shadow-outline-green dark:focus:shadow-outline-gray">
                                <?php
                ...
                <div id="resi_no" class="flex flex-col lg:flex-row lg:space-x-4 mt-2">
                    ...
                    <span class="text-gray-800 font-bold mt-2 lg:flex-1">
                        <label class="block text-sm">
                            <input type="text" name="resi" onchange="changeStatusOrder(this)" class="block w-full text-sm  bg-gray-100 focus:bg-white form-input focus:border-green-400 focus:outline-none focus:shadow-outline-green ">
                        </label>
                    </span>
                </div>
            </div>
            ...
            <div class="py-4 flex flex-col" id="uploadTransferModalBody">
                <div class="flex flex-col lg:flex-row lg:space-x-4 mt-2">
                    ...
                    <span class="text-gray-800 font-bold md:mt-0 mt-2 lg:flex-1">
                        <label class="block text-sm" id="change_status_order">
                            <?php $array = array("01"=>"JANUARY","02"=>"FEBRUARY",
                                                 "03"=>"MARCH","04"=>"APRIL",
                                                 "05"=>"MEI","06"=>"JUNE",
                                                 "07"=>"JULY","08"=>"AUGUST",
