  ...
  <div class="container flex items-center justify-between h-full mx-auto px-6 ">
    ...
    <div class="flex xs:hidden hidden md:block mx:auto">
      <div class="relative w-full space-x-12 flex max-w-xl focus-within:text-green-500">
        <div class="flex-1">
          <a href="<?= base_url(); ?>show-all-items" class="inline-flex tracking-widest items-center w-full text-md font-bold transition-colors duration-150 uppercase text-gray-600 hover:text-green-500">
            Shop
          </a>
        </div>
        <div class="flex-1">
