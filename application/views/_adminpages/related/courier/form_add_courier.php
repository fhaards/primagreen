...
<?php echo form_open('product/add-courier', array('class' => 'bg-white shadow-xs rounded-lg px-4 py-2 flex flex-col space-y-4 ')); ?>
<div class="border-b-2 border-gray-200 mb-2  py-4">
    <h1 class="font-bold tracking-wide text-sm text-gray-600">New Courier Form</h1>
</div>
