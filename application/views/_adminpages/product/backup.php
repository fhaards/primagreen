<div class="flex md:flex-row space-x-5">
    <div class="flex-1 flex md:flex-row w-full py-5 px-4 mb-5 bg-white rounded-lg relative shadow-xs">
        <div class="flex flex-col space-y-2 w-full md:space-y-0 md:space-x-5 md:w-auto md:flex-row">
            <select name="" class="common_selector form-select">
                <option value="sel-all">Select All Types</option>
    ...
    <div class="flex md:flex-row-reverse py-5 px-4 mb-5 bg-white rounded-lg relative shadow-xs">
        <div class="flex flex-col space-y-2 w-full md:space-y-0 md:space-x-5 md:w-auto md:flex-row">
