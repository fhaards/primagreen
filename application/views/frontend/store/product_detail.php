<section class="w-full mx-auto mt-20 lg:mt-32 ">
    <div class="container flex flex-wrap pt-4 pb-2">
        <div class="md:flex-1 w-full" style="height:35rem;max-height:35rem;">
            <div x-data="{ image: 1 }" x-cloak>
                <div class="lg:w-4/5 mb-4 items-center" style="height:30rem;max-height:30rem;">
                    <?php
                    ...
                    ?>
                    <div x-show="image === 1" class="lg:w-5/5 flex flex-wrap bg-gray-100 mb-4 tems-center justify-center <?= $hiddenClass1; ?>" >
                        <img class="lg:w-full w-full object-cover" style="height:30rem;max-height:30rem;" src="<?php echo base_url() . 'uploads/product/' . $urlImage1; ?>">
                    </div>

                    <div x-show="image === 2" class="lg:w-5/5 flex flex-wrap bg-gray-100 mb-4  items-center justify-center <?= $hiddenClass2; ?>">
                        <img class="lg:w-full w-full object-cover" style="height:30rem;max-height:30rem;" src="<?php echo base_url() . 'uploads/product/' . $urlImage2; ?>">
                    </div>

                    <div x-show="image === 3" class="lg:w-5/5 flex flex-wrap bg-gray-100 mb-4 items-center justify-center <?= $hiddenClass3; ?>">
                        <img class="lg:w-full w-full object-cover" style="height:30rem;max-height:30rem;" src="<?php echo base_url() . 'uploads/product/' . $urlImage3; ?>">
                    </div>
                </div>
        ...
        <div class="md:flex-1 lg:pl-5">
            <div class="flex mb-6">
                ...
                <div>
                    <div class="rounded-sm shadow-xs bg-green-500 flex py-1 px-2">
                        <span class="text-white mr-2 mt-1 text-xs">IDR</span>
                        <span class="font-bold text-white text-2xl items-center"><?= number_format($getDetail['harga']); ?></span>
                    </div>
                </div>
            </div>
