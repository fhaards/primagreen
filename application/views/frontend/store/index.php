<section class="store-banner min-w-full w-full mx-auto flex md:items-center bg-cover bg-right" style="height:500px;">
    <div class="container mx-auto px-6 text-gray-800 w-full">
        <div class="flex flex-col items-center tracking-wide md:mx-0 mx-auto ">
            ...
            <a href="<?= base_url('store/all-items') ?>" class="flex flex-row space-x-3 text-gray-800 border-2 border-white py-1 px-4 bg-white rounded-md font-bold hover:bg-gray-800 hover:text-white hover:border-gray-800">
