...
<div class="my-2">
    <label>
        ...
        <input name="nama" type="text" value="<?= getUserData()['nama']; ?>" class="block w-full mt-1 text-sm dark:border-gray-600  focus:border-green-400 focus:outline-none focus:shadow-outline-green bg-gray-100 focus:bg-white form-input" />
    </label>
</div>
<div class="my-2">
    <label>
        <p class="text-gray-600 font-semibold text-sm">Email</p>
        <input name="email" type="email" value="<?= getUserData()['email']; ?>" class="block w-full mt-1 text-sm dark:border-gray-600  focus:border-green-400 focus:outline-none focus:shadow-outline-green bg-gray-100 focus:bg-white form-input" />
    </label>
</div>
<div class="my-2">
    <label>
        <p class="text-gray-600 font-semibold text-sm">Telphone</p>
        <input name="tlp" type="text" value="<?= getUserData()['tlp']; ?>" class="block w-full mt-1 text-sm dark:border-gray-600  focus:border-green-400 focus:outline-none focus:shadow-outline-green bg-gray-100 focus:bg-white form-input" />
    </label>
</div>
<div class="py-4">
