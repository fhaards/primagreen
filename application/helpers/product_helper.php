...
function stockInList($var)
{
    ...
    $stockInListOutput  =   '<div class="flex mx-auto py-1 px-4 rounded-md text-justify ' . $stockBackground . '">
                                ...
                                <div class="flex flex-row items-center space-x-4 text-sm">
                                    <label class="block text-sm relative items-center ">
                                        ...
                                        <input type="number" min="0" name="stock" value="' . $var . '" class="block w-20 pl-4 ml-3 text-xs font-bold py-1 focus:border-green-400 focus:outline-none focus:shadow-outline-green bg-gray-100 focus:bg-white dark:text-gray-300 dark:focus:shadow-outline-gray form-input" />
                                    </label>
                                    <button type="submit" class="flex items-center justify-between px-1 shadow-md py-1 text-sm font-medium leading-5 bg-blue-500 rounded-md hover:bg-blue-700">
